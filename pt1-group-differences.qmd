...
- Compare the proportions of a binomial dependent variable between the two levels of a binomial independent variable with a **two-sample _z_-test** (@sec-tsztest). 
